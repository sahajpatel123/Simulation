...
class Outcome(Base, TimestampMixin):
    ...
    # Quoted despite ``from __future__ import annotations``: an unquoted
    # dotted path is a module-level attribute use that re-triggers the
    # cyclic-import pattern this file layout exists to avoid.
    project: Mapped["app.models.project.Project"] = relationship(  # noqa: UP037
        "Project", back_populates="outcomes"
    )
