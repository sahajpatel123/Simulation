...
ARCHITECT_STACKS: dict[ProductType, list[str]] = {
    ProductType.SAAS: [
        ...
        "TrustArchitect", "PaymentFrictionArchitect", "PricingArchitect", "OnboardingArchitect",
    ...
    ProductType.HEALTH_HARDWARE: [
        ...
        "AccessibilityInclusionArchitect",
        "SustainabilityArchitect",
        "TrustArchitect", "PaymentFrictionArchitect", "HealthSafetyHardwareArchitect",
    ...
    ProductType.DIRECT_TO_CONSUMER: [
        ...
        "AccessibilityInclusionArchitect",
        "SustainabilityArchitect",
        "TrustArchitect", "PaymentFrictionArchitect", "PricingArchitect", "PurchaseDecisionArchitect",
