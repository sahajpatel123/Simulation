...
def export_my_simulations(
    ...
    if fmt == "json":
        ...
        return StreamingResponse(
            ...
            media_type="application/json; charset=utf-8",
            headers={
                "Content-Disposition": 'attachment; filename="my-simulations.json"',
                "Content-Length": str(len(body)),
            },
        )
...
def export_my_outcomes(
    ...
    if fmt == "json":
        ...
        return StreamingResponse(
            ...
            media_type="application/json; charset=utf-8",
            headers={
                "Content-Disposition": 'attachment; filename="my-outcomes.json"',
                "Content-Length": str(len(body)),
            },
        )
...
def export_my_account(
    ...
    if fmt == "json":
        ...
        return StreamingResponse(
            ...
            media_type="application/json; charset=utf-8",
            headers={
                "Content-Disposition": 'attachment; filename="my-account.json"',
                "Content-Length": str(len(body)),
            },
        )
