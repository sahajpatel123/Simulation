"""Route-level tests for the /projects/{id}/landing/export endpoint."""
...
def test_export_landing_returns_csv() -> None:
    resp = _call_route()

    assert resp.media_type == "text/csv; charset=utf-8"
    assert 'filename="landing-10.csv"' in resp.headers["Content-Disposition"]
