"""Route-level tests for the batch what-if scenario comparison endpoint."""
...
def _call_route(
    *,
    ...
    return sim_mod.post_what_if_batch(
...
def test_completed_simulation_returns_ranked_batch() -> None:
    out = _call_route()
    ...
    assert out.scenarios[0].scenario.meta["existing_assumptions_count"] == 1
