"""Route-level tests for the /simulations/{id}/validation-roi endpoint.
"""
...
def _call_route(
    *,
    ...
    return sim_mod.get_validation_roi(
...
def test_completed_simulation_returns_roi_payload() -> None:
    out = _call_route()
    ...
    assert out.assumptions[0].roi_tier == "VALIDATE_FIRST"
    assert out.recommendations
    assert out.meta["assumption_count"] == 2
