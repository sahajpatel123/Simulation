"""Route-level tests for the /projects/{id}/duplicate-title endpoint."""
...
class _Project:
    def __init__(self, project_id: int = 1, title: str = "TheCee") -> None:
        self.id = project_id
        self.title = title
...
def test_get_duplicate_title_returns_list() -> None:
