"""Route-level tests for the /simulations/{id}/activation-funnel endpoint.
"""
...
def _call_route(
    *,
    ...
    return sim_mod.get_activation_funnel(
...
def test_completed_simulation_returns_activation_funnel_payload(
...
def test_hardware_product_type_returns_insufficient_data(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
