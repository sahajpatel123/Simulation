"""Route-level tests for the /simulations/{id}/export endpoint."""
...
def _call_route(
    *,
    ...
    return sim_mod.get_simulation_export(
...
def test_completed_simulation_returns_csv_export() -> None:
    resp = _call_route()

    assert resp.media_type == "text/csv; charset=utf-8"
    assert 'filename="simulation-1.csv"' in resp.headers["Content-Disposition"]
...
def test_missing_simulation_raises_404() -> None:
